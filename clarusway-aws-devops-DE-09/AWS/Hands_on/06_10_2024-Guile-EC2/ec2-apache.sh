...
The Apache HTTP Server, known as Apache, is a free and open-source cross-platform web server software, which is developed
and maintained by an open community of developers under the auspices of the Apache Software Foundation.
...
Region: "N.Virginia"
VPC: "Default VPC"
Securtiy Group: "0.0.0.0/0-----> SSH - Port 22"
                "0.0.0.0/0-----> Http - Port 80"
...
7. Enable the Apache Web Server to restart it if the instance reboots.
